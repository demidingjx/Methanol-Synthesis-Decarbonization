...
ed_points = [55, 25, 50, 76, 75, 100]

             
template_path = Path(
    r"E:\2025_Methanol_synthesis\3_GAMS\P1_Processing_LCOM\gdx\LCOM_Statewide_gdx_to_csv.gms"
)
...
for ed in ed_points:
    ...
    out_gms = out_dir / f"LCOM_Statewide_ED{ed}.gms"
