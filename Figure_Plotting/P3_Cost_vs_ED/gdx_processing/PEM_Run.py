...
# 3) 模板路径（当前示例为 PEM 模板）
template_path = Path(
    r"F:\2025_Methanol_synthesis\3_GAMS\P2_Cost_vs_ED\gdx_processing\Total_cost\Total_Cost_breakdown_PEM_gdx_CAP.gms"
)
#C_cost_breakdown_PEM
#P_cost_breakdown_PEM
#Total_Cost_breakdown_PEM_gdx_CAP
...
for yr, ed_list in year_ed_map.items():
    for ed in ed_list:
        ...
        # 生成输出文件名（按需改成 PEM 或 PEM）
        out_gms = out_dir / f"Total_Cost_PEM_YR{yr}_ED{ed}.gms"
