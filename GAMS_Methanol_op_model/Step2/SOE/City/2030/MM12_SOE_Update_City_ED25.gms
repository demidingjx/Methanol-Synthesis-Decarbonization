...
$Set Sfolder E:\2025_Methanol_synthesis\3_GAMS\GDX7_M12_Fix\%EL%\%YS%\ED%ED%\
...
Execute_Unload '%Sfolder%s2C_%EL%_%YS%_ED%ED%.gdx' yre, DOI, U_nom, N_modules, P_PV, P_WT, En_ES, ChgP, DisP, 
