...
$Set Sfolder E:\2025_Methanol_synthesis\3_GAMS\csv_Single_Prov\test\
$Set Gfolder E:\2025_Methanol_synthesis\3_GAMS\csv_Single_Prov\288_gdx\%el%\
...
Execute_Unload '%Sfolder%S_%EL%_%YS%_ED%ED%.gdx' yre, DOI, U_nom, N_modules, P_PV, P_WT, En_ES, ChgP, DisP, P_city_PV, P_city_WT, P_city, P_exp_PV, P_exp_WT, P_exp, P_imp
